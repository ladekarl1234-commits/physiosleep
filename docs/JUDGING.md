...
| Data / ML / reproducibility | 53/100 | Final review pending | Current development fit verification and final staged publication review underway |

The [initial specialist rubric](../evidence/judging/sleep-specialist-initial.json), [specialist rescore](../evidence/judging/sleep-specialist-final.json) and [initial ML rubric](../evidence/judging/ml-initial.json) preserve individual criteria. Scores grade the available evidence, not a claim that this project meets its benchmark.
...
- Expose the score-eligible 61/119 recordings and40/60 people, failed component targets, bias/P90, descriptive uncertainty and18-configuration sensitivity.
...
- Repair the public test dependency/fixture omissions and rerun all92tests in a fresh local environment.
