...
| Development candidate provenance | [Private-crosswalk aggregate](../evidence/model-lineage-crosswalk-20260925.json), [fixed-rubric review](../evidence/judging/ml-candidate-lineage-regrade.json) | Complete candidate-development credit; full immutable artifact ancestry remains 6/7; best DEV pipeline differs from A/B checkpoint |
