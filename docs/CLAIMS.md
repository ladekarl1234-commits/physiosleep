...
| Score errors 6.37 / 24.71 / 73.31 | Provisional study aggregate figures; retained hashed receipt | Eligible 61 nights / 40 people; targets unmet |
| Saved-fold compatibility parity | Hash-bound native float32 parity result | One held record under one saved fold; not Docker-equivalence |
...
| Literature scores | Attributed workbook context and selected primary checks | Different cohorts/windows/aggregation; never head-to-head |
