...
def pipeline():
    ...
    box(.2,.1,8.1,1.1,'Future confirmation · NOT_RUN','Adequate 11-slot benchmark → readiness → Audit A → reduced model freeze → Audit B','#eef0f4')
